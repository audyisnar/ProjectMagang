...
const PostNews = () => {
    ...
    //                                    dfsd {/* <p className="text-xl font-semibold">{newsId.title}</p> */}
    //                                 </div>
    //                                 <div id="content">
    //                                     dsads{/* <div dangerouslySetInnerHTML={{ __html: newsId.data }} /> */}
    //                                 </div>
    //                             </div>
    //                         </div>
    ...
    //                         <div className="mt-4 mb-10 p-14 bg-white shadow-2xl space-y-6 rounded-xl mx-auto max-w-full">
    //                                 <div className="flex items-center justify-center lg:h-12">
    //                                     12132{/* <p className="text-xl font-semibold">{newsEn.title}</p> */}
    //                                 </div>
    //                                 <div id="content">
    //                                     21321{/* <div dangerouslySetInnerHTML={{ __html: newsEn.data }} /> */}
    //                                 </div>
    //                             </div>
    //                         </div>
    //                     </div>
